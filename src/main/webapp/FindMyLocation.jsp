...
<FORM action="https://api.att.com/oauth/authorize?client_id=3b13b84938eff99458bed9227b559dcc&scope=TL&redirect_uri=http://authorizeobo-ericssonsandbox.rhcloud.com/authorized" method="get">
<INPUT type="button" name="ATT" value="AT&T Subscriber, click here"><BR>
